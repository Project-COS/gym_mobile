        ...
        child: Column(
          ...
          children: [
            ...
            _SheetSummaryRow(
              icon: Icons.location_on_rounded,
              label: 'Lokasi',
              value: selectedSlot.location ?? session.location,
            ),
            const SizedBox(height: 16),
            const _SheetAlert(
              text:
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: _DetailActionButton(
                    label: isSubmitting ? 'Memproses' : 'Konfirmasi',
                    icon: Icons.verified_rounded,
                    isPrimary: true,
      ...
      child: ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
          ...
          disabledBackgroundColor: isPrimary
              ? AppColors.gymGold.withValues(alpha: 0.72)
    ...
    return OutlinedButton(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            slot.branch == null ? slot.day : '${slot.day} - ${slot.branch}',
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
            style: TextStyle(
